...
public class SqlGenSelectUpsertTest {
    ...
    public void testMakeUpsert1() {
        ...
        // Validate the generated SQL structure
        validateGeneratedUpsertSql1(generatedSql, target);
    }
    ...
    public void testMakeUpsert2() {
        ...
        // Validate the generated SQL structure
        validateGeneratedUpsertSql2(generatedSql, target);
    }
    ...
    private void validateGeneratedUpsertSql1(String sql, tech.ydb.mv.model.MvTarget target) {
        // Check for DECLARE statement
        Assertions.assertTrue(sql.startsWith("DECLARE $"),
                "SQL should start with DECLARE statement");
        Assertions.assertTrue(sql.contains("DECLARE " + MvSqlGen.SYS_KEYS_VAR + " AS "),
    ...
    private void validateGeneratedSelectSql2(String sql, tech.ydb.mv.model.MvTarget target) {
        // Check for DECLARE statement
        Assertions.assertTrue(sql.startsWith("DECLARE $"),
                "SQL should start with DECLARE statement");
        Assertions.assertTrue(sql.contains("DECLARE " + MvSqlGen.SYS_KEYS_VAR + " AS "),
    ...
    private void validateGeneratedUpsertSql2(String sql, tech.ydb.mv.model.MvTarget target) {
        // Check for DECLARE statement
        Assertions.assertTrue(sql.startsWith("DECLARE $"),
                "SQL should start with DECLARE statement");
        Assertions.assertTrue(sql.contains("DECLARE " + MvSqlGen.SYS_KEYS_VAR + " AS "),
