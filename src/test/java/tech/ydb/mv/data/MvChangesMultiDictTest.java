...
public class MvChangesMultiDictTest {
    ...
    private MvViewPart targetSingleDict;
    private MvViewPart targetMultiDict;
    ...
    public void setUp() {
        ...
        targetSingleDict = new MvViewPart("target_single");
        ...
        targetMultiDict = new MvViewPart("target_multi");
    ...
    public void testSingleDictRelevantFieldChange() {
        ...
        Set<MvViewPart> filteredTargets = new HashSet<>();
